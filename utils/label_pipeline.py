...
"""
Tentative: Move this section to main.py
...
def build_label_pipeline(spark, start_date_str="2023-01-01", end_date_str="2024-12-01"):
    ...
    # run silver backfill
    for date_str in dates_str_lst:
        utils.data_processing_silver_table.process_silver_table(date_str, bronze_loan_directory, silver_loan_directory, spark)
